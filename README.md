...
* Verge Daemon v6.0.0 (Fully Synced) -> verge-6.0.0-x86_64-linux-gnu.tar.gz [https://github.com/vergecurrency/VERGE/releases]
```
...
Download & extract from `verge-6.0.0-x86_64-linux-gnu.tar.gz` [https://github.com/vergecurrency/VERGE/releases]
